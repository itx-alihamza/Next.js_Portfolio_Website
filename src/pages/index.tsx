            ...
            <div className=" flex flex-col w-[48%] gap-6 items-center self-center">
              ...
              <div className="w-full flex flex-row gap-3 text-lg justify-start items-center">
                <Link
                  ...
                  target="_blank"
                  download={true}
                  className="border-2 flex flex-row justify-center items-center px-2 gap-2 w-40 h-[52px] font-bold text-light hover:bg-light hover:text-dark hover:border-black  bg-dark rounded-md dark:bg-light dark:text-dark hover:dark:bg-dark hover:dark:text-light hover:dark:border-light"
                >
                  Resume
